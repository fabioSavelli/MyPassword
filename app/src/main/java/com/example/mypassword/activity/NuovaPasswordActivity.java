...
public class NuovaPasswordActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sitoWeb     = findViewById(R.id.sitoNuovaPassword);
        username    = findViewById(R.id.usernameNuovaPassword);
        password    = findViewById(R.id.passwordNuovaPassword);
        appunti     = findViewById(R.id.appuntiNuovaPassword);

        // init biometric
        executor = ContextCompat.getMainExecutor(this);
        biometricPrompt = new BiometricPrompt(NuovaPasswordActivity.this,
    ...
    public void salvaNuovaPassword(View view) {
        ...
        account = new Account();
        account.setId(SaveUtility.getNewId(this));
    ...
    public void lanciaModalPin(){
        ...
        bottomSheetDialog = new BottomSheetDialog(NuovaPasswordActivity.this, R.style.BottomSheetDialogTheme);
        ...
        bottoneConfermaInserisciPin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(SaveUtility.findPin(NuovaPasswordActivity.this).equals(pin)){
                    salvataggio(account);
    ...
    private void salvataggio(Account account){
        ...
        SaveUtility.salvaListaAccount(this, listaAccount);

        Toast.makeText(getApplicationContext(), "Account salvato correttamente", Toast.LENGTH_SHORT).show();
